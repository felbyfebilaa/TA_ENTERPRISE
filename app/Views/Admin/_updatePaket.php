<?php foreach ($pakets as $a => $update) : ?>
    <div class="modal fade" id="modal-lg-<?= $update['id_paket']; ?>">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="/Admin/updatePaket/<?= $update['id_paket']; ?>" method="post" enctype="multipart/form-data">
